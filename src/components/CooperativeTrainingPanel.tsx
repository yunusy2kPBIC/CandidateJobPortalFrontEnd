  ...
  return <>
    ...
    {showForm && <form className="panel admin-job-form cooperative-training-form" onSubmit={(event) => void saveRequest(event)}>
      <div className="panel-heading">
        <div><h2>{editing ? 'Edit cooperative training request' : 'New cooperative training request'}</h2><p>Cooperative training request fill out form. With applicant, education, training, and document details.</p></div>
