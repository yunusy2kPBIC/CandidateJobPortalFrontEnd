          ...
          {activeTab === 'requests' && <>
            {showRequestForm && <form className="panel admin-job-form recruitment-request-form" onSubmit={(event) => void saveRecruitmentRequest(event)}>
              ...
              <div className="admin-job-fields recruitment-request-fields">
                ...
                <label>Date of birth (18+ years)<input required type="date" max={latestAdultBirthDate()} title="Applicant must be at least 18 years old" value={requestForm.date_of_birth} onChange={(event) => setRequestForm({ ...requestForm, date_of_birth: event.target.value })} /></label>
